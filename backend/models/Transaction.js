...
const transactionSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['Deposit', 'Withdrawal', 'Transfer_To_Account', 'Transfer_From_Account', 'Account_Transfer_Out', 'Account_Transfer_In', 'Demo_Credit', 'Demo_Reset', 'Admin_Credit', 'Admin_Debit'],
    required: true
  },
  amount: {
    type: Number,
